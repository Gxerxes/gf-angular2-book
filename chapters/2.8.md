...
［通过这个例子讲karma+jasmine的最小集合］

为了使读者能快速理解、入手karma＋jasmine这个测试组合，这里将展示一个简单的例子
...
将启动karma的配置生成器，命令行窗口依次询问要采用的配置，我们一路按回车键，使用默认配置即可，最终将在本地生成karma.conf.js。界面如下图所示
 ...
 ![QQ20160706-0](/Users/lizeyang/gf-angular2-book/_images/chapter2-8/QQ20160706-0.png)
