...
在前文中，已经提到，Angular开发团队，从研发angularjs1.x到Angular2，都特别注意可测性。在Angular2，组件化、依赖注入、使用ECMAScript 2015/2016特性等设计理念，使其单元测试更加便捷。对angular2的程序进行单元测试，学习路线是：
...
接着，生成器询问用户相关的配置项，每个问题均提供了一个建议的配置，也可以按照项目需求输入。如下图所示，第一个问题询问了要使用的测试框架，默认的配置为jasmine，按enter将选择jasmine作为测试框架，也可以按tab切换其它的配置可选值。简单起见，可以均使用默认配置，也就是一路按enter键，最终，将在当前所在目录生成karma.config.js文件
 ...
 ![QQ20160620-0](../_images/chapter2-8/QQ20160620-0.png)
